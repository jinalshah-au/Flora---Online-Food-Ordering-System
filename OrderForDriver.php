...
if(isset($_POST['submit'])){
    ...
    $order_final = new Order($id,"",$status,"","","","");
    if(controller::updateOrderDriver($order_final)){
...
<body>
    ...
    <header>
        ...
        <nav class="navbar">
            <a class="active" href="DriverDashboard.php" style="font-size:16px;color:white;text-decoration:none;">Home</a>
        </nav>
