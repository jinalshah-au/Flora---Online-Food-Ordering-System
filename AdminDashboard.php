...
<body>
            ...
            <ul>
                ...
                <li>
                    <a href="AdminDish.php">
                        <!-- <img src="image/dinner.png" style="width: 22px; height:25px;"/> -->
    ...
    <div class="wrapper-div">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td><a class="btn" style="color:black;"
                        onclick="viewOrder('<?php echo $order->getOrderId(); ?>')"><?php echo $order->getOrderId();  ?></a>
                </td>
    ...
    function viewOrder($order_id) {
        window.location = 'OrderById.php?id=' + $order_id;
    };
    </script>
