...
if(isset($_POST['submit'])){
    ...
    if(isEmpty($file) || isEmpty($email) || isEmpty($password) || isEmpty($username) || isEmpty($address) || isEmpty($phone)){
        ...
        $driver = new Drivers("",$email,$username,$file,$phone,$password,$address);
        if(controller::addDriver($driver)){
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col" style="margin:10px;padding:10px;">
                    Name :
                    <input type="text" value="" name="name" id="title" class="form-control" style="margin:10px;" placeholder="Name">
                </div>
                <div class="col" style="margin:10px;padding:10px;">
                    Phone :
                    <input type="text" value="" name="phoneNo" id="description" class="form-control" style="margin:10px;" placeholder="Phone">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col" style="margin:10px;padding:10px;">
                    Email :
                    <input type="text" value="" name="email" id="title" class="form-control" style="margin:10px;" placeholder="Email">
                </div>
                <div class="col" style="margin:10px;padding:10px;">
                    Password :
                    <input type="text" value="" name="password" id="description" class="form-control" style="margin:10px;" placeholder="Password">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col" style="margin:10px;padding:10px;">
                    Address :
                    <input type="text" name="addr" class="form-control" style="margin:10px;" placeholder="Address">
                </div>
                <div class="col" style="margin:10px;padding:10px;">
