...
if(isset($_POST['submit'])){
    ...
    if(isEmpty($title) || isEmpty($description) || isEmpty($price) || isEmpty($category) || isEmpty($cholestrol) || isEmpty($carbs) || isEmpty($protein)){
        ...
        $dish = new Dish("",$price,$title,$description,$category,$cholestrol,$protein,$carbs,"",$file);
...
<body>
    ...
    <header style="justify-content:left;height:60px;">
        ...
        <nav class="navbar">
            <a class="btn" href="AdminDish.php"
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col" style="margin:10px;padding:10px;">
                    Title :
                    <input type="text" name="title" id="title" class="form-control" style="margin:10px;" placeholder="Dish title">
                </div>
                <div class="col" style="margin:10px;padding:10px;">
                    Description :
                    <input type="text" name="description" id="description" class="form-control" style="margin:10px;" placeholder="write a short description about the dish">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col" style="margin:10px;padding:10px;">
                    Price :
                    <input type="text" name="price" class="form-control" style="margin:10px;" placeholder="Price">
                </div>
                <div class="col" style="margin:10px;padding:10px;">
            ...
            <div class="row">
                <div class="col" style="margin:10px;padding:10px;">
                    Category :
                    <input type="text" name="category" class="form-control" style="margin:10px;" placeholder="Category">
                </div>
                <div class="col" style="margin:10px;padding:10px;">
                    Cholestrol :
                    <input type="text" name="cholestrol" class="form-control" style="margin:10px;" placeholder="Cholestrol">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col" style="margin:10px;padding:10px;">
                    Carbs :
                    <input type="text" name="carbs" class="form-control" style="margin:10px;" placeholder="Carbs">
                </div>
                <div class="col" style="margin:10px;padding:10px;">
                    Protein :
                    <input type="text" name="protein" class="form-control" style="margin:10px;" placeholder="Protein">
                </div>
            </div>
